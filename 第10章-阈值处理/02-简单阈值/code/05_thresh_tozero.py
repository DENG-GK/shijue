...
plt.suptitle('THRESH_TOZERO 置零效果', fontsize=14, fontweight='bold')
plt.tight_layout()
plt.savefig('thresh_tozero_images.png', dpi=150, bbox_inches='tight')
plt.show()
...
ax.set_title('THRESH_TOZERO: 像素值变换曲线', fontsize=14)
ax.legend()
...
plt.tight_layout()
plt.savefig('thresh_tozero_curve.png', dpi=150, bbox_inches='tight')
plt.show()
